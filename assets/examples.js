 // Handle login form submission
        $('#loginForm').submit(function (e) {
            ...
            const url = `api.php?mode=login&username=${username}&password=${password}&nextpage=${encodeURIComponent(nextPage)}`;
        ...
        $('#signupForm').submit(function (e) {
            ...
            const url = `api.php?mode=signup&username=${username}&password=${password}&nextpage=${encodeURIComponent(nextPage)}`;
